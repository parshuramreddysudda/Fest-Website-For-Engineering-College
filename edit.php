...
<nav class="navbar navbar-light navbar-expand-md">
    ...
    <form class="form card container" action="edit.php" >
...
<form class="form card container" action="editSuccess.php">
...
<div class=' container'>
    ...
    <label for='uname'><b>Id</b></label>
    <input type='text' placeholder='Enter Id Number'  disabled  id='id'  required >
     <input type='text' placeholder='Enter Id Number'  hidden name='id' id='id1'  required>
       <label for='uname'><b>Team name</b></label>
    <input type='text' placeholder='Enter Id Number' name='Tname' id='Tname'  required>
      <label for='uname'><b>Date</b></label>
    <input type='text' placeholder='Enter Date of Taking' name='date' id='date'  required>
      <label for='uname'><b>Description</b></label>
  <input rows='20' cols='30'  name='desc' id='desc'> <div class='card'>
    <div class='card-body'>
            ...
            <table class='table'>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input  disabled type='text'  id='roll1'/> <input hidden  type='text' name='roll1' id='roll11'/></td>
                        <td><input  type='text' name='no1' id='no1'/></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td><input  type='text' name='name2' id='name2'/></td>
                        <td><input  disabled type='text' id='roll2' /> <input hidden type='text' id='roll21' name='roll2'/></td>
                        <td><input  type='text' name='no2'  id='no2'/></td>
                    </tr>
                    <tr>
                        <td><input  type='text' name='name3'  id='name3'/></td>
                        <td><input  disabled type='text' id='roll3' /><input hidden type='text' id='roll31'  name='roll3' /></td>
                        <td><input  type='text' name='no3'  id='no3'/></td>
                    </tr>
                      <tr>
                        <td><input  type='text' name='name4'  id='name4'/></td>
                        <td><input  disabled type='text' id='roll4'  /> <input hidden type='text' id='roll41'  name='roll4' /></td>
                        <td><input  type='text' name='no4'  id='no4'/></td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <input type='text'  placeholder='Yes are No ' name='paid'  id='paid' required>
      <label for='uname'><b>Room</b></label>
    <input type='text'  placeholder='Room Number allocated ' name='room' id='room' required>
      <label for='uname'><b>Allocated</b></label>
    <input type='text'  placeholder='Yes or No' name='alloca' id='alloca' required>

    <label for='psw'><b>Type</b></label>
    <input type='text'  placeholder='Technical or Non Technical' name='type' id='type' required>
      ...
      echo "
         ...
         document.getElementById('date').value = '$res[3]' 
          ...
          document.getElementById('roll1').value = '$res[12]' 
           document.getElementById('roll11').value = '$res[12]' 
          ...
          document.getElementById('roll2').value = '$res[13]' 
             document.getElementById('roll21').value = '$res[13]' 
          ...
          document.getElementById('roll3').value = '$res[14]' 
            document.getElementById('roll31').value = '$res[14]' 
          ...
          document.getElementById('roll4').value = '$res[15]' 
             document.getElementById('roll41').value = '$res[15]' 
